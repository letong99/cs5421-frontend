...
const rows = [
  ...
  createData("Honeycomb", 408, 3.2, 87, 6.5, 432),
  createData("Ice cream sandwich", 237, 9.0, 37, 4.3, 54),
  createData("Jelly Bean", 375, 0.0, 94, 0.0, 5),
  createData("KitKat", 518, 26.0, 65, 7.0, 9),
  createData("Lollipop", 392, 0.2, 98, 0.0, 3),
  createData("Marshmallow", 318, 0, 81, 2.0, 4),
  createData("Nougat", 360, 19.0, 9, 37.0, 5),
  createData("Oreo", 437, 18.0, 63, 4.0, 4),
];
